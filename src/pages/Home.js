...
const Home = () => {
  ...
  return (
    <motion.section 
      ...
      className='section md:overflow-hidden'>
      <div className='container mx-auto h-full relative'>
        ...
        <div className='flex flex-col justify-center'>
          ...
          <motion.div 
            ...
            className='text-center md:text-left w-full pt-36 pb-14 lg:pt-0 lg:pb-0 lg:w-auto z-10 lg:absolute flex flex-col justify-center items-center lg:items-start'
          >
            <h1 className='h1'>
